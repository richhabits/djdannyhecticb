...
CREATE INDEX idx_shouts_approved ON shouts(approved);
CREATE INDEX idx_shouts_is_track_request ON shouts(isTrackRequest);
CREATE INDEX idx_shouts_created_at ON shouts(createdAt);
CREATE INDEX idx_shouts_approved_created ON shouts(approved, createdAt);
CREATE INDEX idx_shouts_track_request_approved ON shouts(isTrackRequest, approved);
