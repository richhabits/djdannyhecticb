...
export default function AdminHub() {
  const sections = [
    ...
    {
      name: "Portal Clients",
      description: "Client portal — artists, brands & bookers",
      icon: Users,
      href: "/admin/portal",
      category: "business",
      color: "text-orange-500",
    },
    {
      ...
      description: "Review client portal booking requests",
      icon: Bookmark,
      href: "/admin/portal/bookings",
      category: "business",
      color: "text-amber-500",
    },
    {
      name: "Upload Review",
      description: "Approve / reject client uploads",
      icon: Package,
