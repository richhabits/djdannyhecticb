...
YOUTUBE_DATA_API_KEY=<REDACTED_GOOGLE_API_KEY>
GOOGLE_AI_API_KEY=<REDACTED_GOOGLE_API_KEY>

TWITCH_CLIENT_ID=<REDACTED_TWITCH_CLIENT_ID>
TWITCH_CLIENT_SECRET=<REDACTED_TWITCH_CLIENT_SECRET>

DATABASE_URL=postgresql://postgres:<REDACTED_DB_PASSWORD>@db.mzfpsfnmeacbknpcpibj.supabase.co:5432/postgres

TICKETMASTER_API_KEY=<REDACTED_TICKETMASTER_API_KEY>
